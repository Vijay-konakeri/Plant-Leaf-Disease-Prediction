...
tomato_plant = cv2.imread('C:/Users/Vijay/AppData/Local/Programs/Python/Python38/Tomato_Leaf_Disease_Prediction/Dataset/test/Tomato___Bacterial_spot (1).JPG')
